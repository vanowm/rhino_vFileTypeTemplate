# vFileTypeTemplate  ·  v26.7.23.017

vFileTypeTemplate is a Rhino 8 plug-in that applies a chosen Rhino template automatically after a mapped file type is opened.
...
The Release plug-in is `bin/Release/net7.0-windows/vFileTypeTemplate.dll`. Load it with Rhino's Plug-in Manager and keep `vFileTypeTemplate.config.json` beside the DLL when deploying predefined mappings.
